...
module.exports = {
  ...
  rules: { mode: 'untimed' },
  controls: {
    scheme: 'aim',              // касание/мышь = огонь в ту сторону (точный угол)
    aim: { fire: 'attack' },
    buttons: [
      { glyph: '◀', key: 'ArrowLeft', x: 0.09, y: 0.88 },
      { glyph: '▶', key: 'ArrowRight', x: 0.24, y: 0.88 },
      { glyph: '▲', action: 'jump', x: 0.165, y: 0.74 },
    ],
  },
  platformer: {
