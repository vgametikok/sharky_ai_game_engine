  ...
  function body() {
    switch (st.step) {
      ...
      case 4: return h('div.panel', {},
        ...
        h('p.hint', {}, 'Нет ключа? Шаг можно пропустить: заполни описание и нажми «Сохранить черновик» — сгенерируешь позже.'),
        h('p.hint', {}, h('span', {}, 'Совсем без оплаты: '),
          h('a', { href: '#/import' }, 'создай игру из CONFIG'),
          h('span', {}, ' — опиши игру Claude в Claude Code, вставь готовый JSON, и движок соберёт её бесплатно.')),
      );
