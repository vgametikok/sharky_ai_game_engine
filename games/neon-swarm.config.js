...
module.exports = {
  ...
  shmup: {
    ...
    player: { w: 26, h: 30, speed: 300, hp: 3, bombs: 3, hitboxR: 3.5, color: '#38e0ff' },
    weapon: {
    ...
    enemies: {
      ...
      drone:  { w: 22, h: 20, hp: 1, speed: 78, color: '#5cf0c0', move: 'sine',
                score: 40, drop: 'up', dropChance: 0.10 },
      // ныряльщик — пикирует на игрока
      dart:   { w: 24, h: 22, hp: 2, speed: 90, color: '#ff8a3d', move: 'dive',
                score: 70, drop: 'up', dropChance: 0.12 },
      // страж — зависает, бьёт веером
      ward:   { w: 30, h: 28, hp: 4, speed: 34, color: '#b48cff', move: 'hover',
      ...
      lancer: { w: 28, h: 26, hp: 3, speed: 52, color: '#ff4d9d', move: 'straight',
                gun: { cooldown: 1.8, speed: 180, aim: 'player' }, score: 100, drop: 'up', dropChance: 0.18 },
      // крейсер — толстый, сыплет пули вниз
      cruiser:{ w: 40, h: 34, hp: 9, speed: 26, color: '#38e0ff', move: 'hover',
